    ...
    <div class="container-fuild">
        ...
        <header class="">
            ...
            <div id="carouselExampleInterval" class="carousel slide text-center " data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active" data-bs-interval="100440000">
            ...
            <div class="container">
                ...
                <div class="header-link">
                    <span><a href="product.html">Trang chủ</a> > </span>
                    <span><a href="signUp.html">Logup</a></span>
                </div>
        ...
        <div class="main-content">
            <main>
                ...
                <link rel="stylesheet" href="/du-an-1-nhom7/public/css/signUp.css">
