...
<div class="col">
    <div class="container">
        <h3 class="text-center my-5 tw-font-semibold tw-text-lg">THÊM KHÁCH HÀNG</h3>
        ...
        <div class="wrapper" style="margin-top: 20px; width: 100%">
            <form class="row g-3 needs-validation" action="index.php?url=customer&act=add" method="post" enctype="multipart/form-data">
                <!-- id -->
                ...
                <div hidden class="col-md-6">
                    ...
                    <div class="check">
                        ...
                        <div class="form-check form-check-inline">
                            <input checked class="form-check-input border-secondary" name="status" type="radio" value="1" />
                ...
                <div class="col-md-6">
                    ...
                    <div class="check">
                        <!-- cus -->
                        <div class="form-check form-check-inline">
                            <input class="form-check-input border-secondary" name="role" type="radio" checked value="0" />
