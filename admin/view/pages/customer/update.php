...
<div class="col">
    <div class="container">
        <h3 class="text-center my-5 tw-font-semibold tw-text-lg">CHỈNH SỬA THÔNG TIN</h3>
        ...
        <div class="d-flex">
            ...
            <a href="index.php?url=customer&act=list" class="text-decoration-none hover:tw-opacity-75 bg-success p-1 px-2 rounded-2 text-light ">Danh sách khách
                hàng</a>
        </div>

        <!-- content -->
        <div class="wrapper" style="margin-top: 20px; width: 100%">
            <form class="row g-3 needs-validation" action="index.php?url=customer&act=update" method="post" enctype="multipart/form-data">
                <!-- id -->
                <div class="col-md-6" hidden>
                    <label for="validationCustom03" class="form-label">Mã khách hàng</label>
                    <input type="text" class="form-control" value="<?= isset($target['customer_id']) ? $target['customer_id'] : '' ?>" name="id" id="validationCustom03" />
                    <div style="color: red"></div>
                </div>
                <!-- tên khách hàng -->
                <div class="col-md-6">
                    <label for="validationCustom03" class="form-label">Họ và Tên<span class="text-danger">*</span></label>
                    <input type="text" class="form-control" value="<?= isset($target['name']) ? $target['name'] : '' ?>" name="name" id="validationCustom03" />
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" value="<?= isset($target['phone']) ? $target['phone'] : '' ?>" name="phone" id="validationCustom03" />
                ...
                <!-- email -->
                <div class="col-md-6">
                    <label for="validationCustom03" class="form-label">Địa chỉ Email<span class="text-danger">*</span></label>
                    <input type="text" class="form-control" name="email" id="validationCustom03" value="<?= isset($target['email']) ? $target['email'] : '' ?>" />
                    <p class="text-danger"><?= isset($err['email']) ? $err['email'] : '' ?></p>
                    <div style="color: red"></div>
                </div>
                <!-- Trạng thái -->
                <div hidden class="col-md-6">
                    <label for="validationCustom03" class="form-label">Trạng thái<span class="text-danger">*</span></label>
                    <div class="check">
                        <!-- on -->
                        ...
                        <!-- off -->
                        <div class="form-check form-check-inline">
                            <input class="form-check-input border-secondary" <?= (isset($target['status']) && $target['status'] == 0) ? 'checked' : '' ?> name="status" type="radio" value="0" />
                ...
                <div class="col-md-6">
                    ...
                    <div class="check">
                        <!-- cus -->
                        <div class="form-check form-check-inline">
                            <input class="form-check-input border-secondary" <?= (isset($target['role']) && $target['role'] == 0) ? 'checked' : '' ?> name="role" type="radio" value="0" />
                            <label class="form-check-label" for="inlineCheckbox1">Khách hàng</label>
                        </div>
                        <!-- ad -->
                        <div class="form-check form-check-inline">
                            <input class="form-check-input border-secondary" <?= (isset($target['role']) && $target['role'] == 1) ? 'checked' : '' ?> name="role" type="radio" value="1" />
