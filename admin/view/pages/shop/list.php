...
<div class=" col ">
    <div class="container">
        <h3 class="text-center my-5 tw-font-semibold tw-text-lg">DANH SÁCH CỬA HÀNG</h3>
        <div class="d-flex ">
            <!-- thêm danh mục -->
        ...
        <div class="d-flex justify-content-center mt-4">
            <nav aria-label="Page navigation example">
                <ul class="pagination">
                    ...
                    ?>
                            <li class="page-item "><a class="page-link border-danger" href="index.php?url=shop&act=list&pagenum=<?= $page ?>">
                                    <?= $page ?>
                                </a>
                            </li>
                    <?php }
