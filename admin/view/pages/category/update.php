    ...
    <div class="container">
        ...
        <div class="wrapper" style="margin-top: 20px; width: 100%">
            ...
            <form class="input" style="width: 50%" method="post" action="index.php?url=category&act=update">
                <input type="text" hidden name="id" value="<?= isset($target['category_id']) ? $target['category_id'] : '' ?>">
                <div class="input-group mb-3">
                    <span class="input-group-text" id="inputGroup-sizing-default">Tên loại<span class="text-danger">*</span></span>
                    <input type="text" class="form-control" name="name" value="<?= isset($target['name']) ? $target['name'] : '' ?>">
                </div>
