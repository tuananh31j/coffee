...
<div class=" col ">
    <div class="container">
        <h3 class="text-center my-5 tw-font-semibold tw-text-lg">DANH SÁCH THƯ LIÊN HỆ</h3>
        <!-- fillter -->
        <div class="d-flex">
            <div class="dropdown m-3">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="index.php?url=contact&filter=<?= isset($filter) ? $filter : 0 ?>">Mới
                            nhất</a></li>
                    <li><a class="dropdown-item" href="index.php?url=contact&sort=old&filter=<?= isset($filter) ? $filter : 0 ?>">Cũ
                            nhất</a></li>
                    <li><a class="dropdown-item" href="index.php?url=contact&sort=<?= isset($sort) ? $sort : 0 ?>&filter=done">Đã
                            xử lý</a></li>
                    <li><a class="dropdown-item" href="index.php?url=contact&sort=<?= isset($sort) ? $sort : 0 ?>&filter=yet">chưa
                            xử lý</a></li>
                </ul>
            </div>
            <!-- tìm kiếm -->
            <div class="m-3">
                <form action="index.php?url=contact&filter=<?= isset($filter) ? $filter : 0 ?>&sort=<?= isset($sort) ? $sort : 0 ?>" method="post">
        ...
        <?php foreach ($listContact as $key => $item) { ?>
            ...
            <div class="row p-3 m-3 rounded-2" style="box-shadow: 5px 5px 10px;">
                ...
                <div class="col">
                    <h4 class="text-success tw-font-semibold">Nội dung</h4>
                    <div>
                ...
                <!-- thông tin người gửi -->
                <div class="col">
                    <h4 class="text-success tw-font-semibold">Thông tin người gửi</h4>
                    <div>
                        <ul>
    ...
    <div class="d-flex justify-content-center mt-4">
        <nav aria-label="Page navigation example">
            <ul class="pagination">
                <li class="page-item"><a class="page-link border-danger" href="index.php?url=contact&act=list&filter=<?php echo isset($filter) ? $filter : 0 ?>">1</a>
                </li>
                <?php
                ...
                ?>
                        <li class="page-item "><a class="page-link border-danger" href="index.php?url=contact&act=list&filter=<?php echo isset($filter) ? $filter : 0 ?>&pagenum=<?= $page ?>">
                                <?= $page ?>
                            </a>
                        </li>
                <?php }
