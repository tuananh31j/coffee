...
<div class=" col ">
    <div class="container">
        ...
        <!-- content -->
        <div>
            <form action="index.php?url=product&act=update" class="row gap-5 align-items-center" method="post" enctype="multipart/form-data">
                <div class="col">
                    <!-- id -->
                    ...
                    <div class="">
                        ...
                        <input type="text" class="form-control" value="<?= isset($target['name']) ? $target['name'] : '' ?>" name="name" id="validationCustom02" />
                        <p class="text-danger"><?= isset($err['name']) ? $err['name'] : '' ?></p>
                    </div>
                    <!-- giảm giá -->
                    <div class="">
                        <label for="validationCustom01" class="form-label">Giảm giá%</label>
                        <input type="text" class="form-control" name="sale" value="<?= isset($target['sale']) ? $target['sale'] : '' ?>" />
                        ...
                        <div class="input-group has-validation">
                            <select class="form-select" name="category" aria-label="Default select example">
                                ...
                                <?php foreach ($listCategory as $cate) { ?>
                                    <option <?php if ($target['category_id'] == $cate['category_id'] && isset($target['category_id'])) {
                                                echo "selected";
                                            } else {
                                                echo '';
                ...
                <div class="row  ms-1">
                    ...
                    <input placeholder="......." type="text" value="<?= isset($target['des']) ? $target['des'] : '' ?>" class="form-control pb-5" name="des" aria-label="file example" />
