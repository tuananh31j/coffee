...
function getCMTById($id){
    $sql = "select comment.*, customer.image_url as imgCus, customer.name as nameCus from comment inner join customer on customer.customer_id = comment.customer_id where comment.product_id = ?";
