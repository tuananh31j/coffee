            ...
            <div class="row gap-4">
                <div class="col ">
                    ...
                    <div hidden class="form-group my-4">
                        <input type="text" class="form-control" name="idCus" value="<?= isset($_SESSION['user']) ? $_SESSION['user']['customer_id'] : '' ?>" id="name" placeholder="Nhập tên của bạn!">
                    </div>
                    <!-- name -->
                    <div class="form-group my-4">
                        <label class="my-2 fw-bold" for="name">Tên người nhận<span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id='name' name="name" value="<?= isset($_SESSION['user']) ? $_SESSION['user']['name'] : '' ?>" id="name" placeholder="Nhập tên của bạn!">
                    ...
                    <div class="form-group my-4">
                        ...
                        <input type="text" id='phone' class="form-control" name="phone" value="<?= isset($_SESSION['user']) ? $_SESSION['user']['phone'] : '' ?>" id="phone" placeholder="Nhập số điện thoại nhận hàng!">
                    ...
                    <div class="form-group my-4">
                        ...
                        <input type="email" id='email' class="form-control" name="email" value="<?= isset($_SESSION['user']) ? $_SESSION['user']['email'] : '' ?>" id="email" placeholder="Nhập email liên hệ của bạn!">
                        <p class="text-danger"><?= isset($err['email']) ? $err['email'] : '' ?></p>
                    </div>

                    <!-- Địa chỉ nhận hàng -->
                    <div class="form-group my-4">
                        <label class="my-2 fw-bold" for="address">Địa chỉ nhận hàng<span class="text-danger">*</span></label>
                        <input id='address' type="text" class="form-control" name="address" value="<?= isset($_SESSION['user']) ? $_SESSION['user']['address'] : '' ?>" id="address" placeholder="Nhập địa chỉ của bạn!">
                    ...
                    <div class="form-group mt-4">
                        ...
                        <input type="text" class="form-control" value="" style="word-wrap: break-word; padding-bottom: 108px;" name="note" id="note" placeholder="Nhập nội dung bạn muốn nhắn gửi đến shop!">
                    </div>
                ...
                <div class="col">
                    ...
                    <div class=" border border-2 border-danger shadow rounded-2 p-4 ">
                        ...
                        <div style="margin-top: 50px" class="cart-total  ">
                            <div class="">
                                <p>Tổng cộng: <span class="text-danger fw-bold fs-3"><?= number_format($totalPrice, 0, ',', '.') ?>
                                        <i class="text-decoration-underline"> đ</i></span></p>
                            </div>

                            <input type="submit" value="Xác nhận" name="btn-pay" class="w-50 text-light bg-danger p-2 border-0 rounded-2">
