                                    ...
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                        <div class="modal-content">
                                                                ...
                                                                <div class="d-flex gap-4 my-3 ms-1 align-items-center">
                                                                    ...
                                                                    <div class="btn-group" role="group"
                                                                        ...
                                                                        <input type="radio" class="btn-check"
                                                                            name="btnradio" id="btnradio1<?=$index?>"
                                                                            autocomplete="off" checked>
                                                                        <label class="btn btn-outline-primary"
                                                                            for="btnradio1<?=$index?>">S</label>

                                                                        <input type="radio" class="btn-check"
                                                                            name="btnradio" id="btnradio2<?=$index?>"
                                                                            autocomplete="off">
                                                                        <label class="btn btn-outline-primary"
                                                                            for="btnradio2<?=$index?>">M</label>

                                                                        <input type="radio" class="btn-check"
                                                                            name="btnradio" id="btnradio3<?=$index?>"
                                                                            autocomplete="off">
                                                                        <label class="btn btn-outline-primary"
                                            ...
                                            <div class="modal-footer">
                                                <!-- <button type="button" class="btn btn-secondary"
                                                            data-bs-dismiss="modal">Close</button> -->
                                                <button type="submit" name="btn-addCart" class="btn btn-primary">Thêm
                                                    vào
                                                    giỏ</button>
