                  ...
                  <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist"
                     ...
                     <a class="text-decoration-none"
                        href="index.php?url=product&category=<?=$item['category_id']?>&sort=<?php echo isset($sort)?$sort:0?>"><button
                           ...
                           aria-controls="v-pills-profile" aria-selected="false"><?=$item['name']?></button></a>
...
>>>>>>> d05f3c93018172289f08f346d69ef23cab2fa40b
                  ...
                  <div class="col mb-4">
                     <div class="card h-100">
                        <!-- ảnh -->
                        <div class="h-100">
                           <a href=""><img src="<?=$IMAGE.'/'.$item['image_url']?>" class="card-img-top" alt="..."></a>
                           <!-- giảm giá -->
...
>>>>>>> d05f3c93018172289f08f346d69ef23cab2fa40b
                        ...
                        <div class="card-body">
                           ...
                           <button type="button" class="btn border-danger text-danger cart-btn" data-bs-toggle="modal"
                              data-bs-target="#exampleModal-<?php echo $index?>">Thêm
                              vào giỏ hàng</button>
                           <!-- form thêm vào giỏ hàng -->
                                 ...
                                 <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                    <div class="modal-content">
                                                      ...
                                                      <div class="d-flex gap-4 my-3 ms-1 align-items-center">
                                                         ...
                                                         <div class="btn-group" role="group"
                                                            ...
                                                            <input type="radio" class="btn-check" name="btnradio"
                                                               id="btnradio1<?=$index?>" autocomplete="off" checked>
                                                            <label class="btn btn-outline-primary"
                                                               for="btnradio1<?=$index?>">S</label>

                                                            <input type="radio" class="btn-check" name="btnradio"
                                                               id="btnradio2<?=$index?>" autocomplete="off">
                                                            <label class="btn btn-outline-primary"
                                                               for="btnradio2<?=$index?>">M</label>

                                                            <input type="radio" class="btn-check" name="btnradio"
                                                               id="btnradio3<?=$index?>" autocomplete="off">
                                                            <label class="btn btn-outline-primary"
                                       ...
                                       <div class="modal-footer">
                                          <!-- <button type="button" class="btn btn-secondary"
                                                            data-bs-dismiss="modal">Close</button> -->
                                          <button type="submit" name="btn-addCart" class="btn btn-primary">Thêm vào
                                             giỏ</button>
                                          <button type="submit" name="btn-payOrder" class="btn btn-danger">Đặt
                                             ngay</button>
                                       </div>
                                    </div>
                                 </div>
