                    ...
                    <div class="row aligh-items-center">
                        <div class="col user-list-infor">
                            <ul class="tw-leading-8">
                                <li>
                                    <p class="fw-bold">Họ tên: <span class="fw-lighter"><?= $_SESSION['user']['name'] ?></span></p>
                                </li>
                                <li>
                                    <p class="fw-bold">Email: <span class="fw-lighter"><?= $_SESSION['user']['email'] ?></span></p>
                                </li>
                                <li>
                            ...
                            <!-- chỉnh sửa -->
                            <div class="tw-my-4">
                                <a href="index.php?url=account&act=update"> <button class="btn bg-danger text-light"><i class="fa-regular fa-pen-to-square"></i> Chỉnh sửa
                                        thông
                                        tin</button></a>
                            </div>
                        </div>
