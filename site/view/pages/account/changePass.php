                 ...
                 <div class="col">
                     ...
                     <div class="user-list-infor">
                         <form action="index.php?url=account&act=changePass" method="post">
                             ...
                             <!-- mật khẩu cũ -->
                             <div class="mb-3">
                                 <label for="exampleInputPassword1" class="form-label">Mật khẩu cũ<span class="text-danger">*</span></label>
                                 <input name="curPass" type="password" class="form-control" id="exampleInputPassword1">
                                 <p class="text-danger">
                                     <?php if (isset($err['curPass'])) {
                                            echo $err['curPass'];
                                        } else {
                                            echo '';
                                        } ?>
                             ...
                             <!-- mật khẩu mới -->
                             <div class="mb-3">
                                 <label for="exampleInputPassword1" class="form-label">Mật khẩu mới<span class="text-danger">*</span></label>
                                 <input name="newPass" type="password" class="form-control" id="exampleInputPassword1">
                                 <p class="text-danger">
                                     <?php if (isset($err['newPass'])) {
                                            echo $err['newPass'];
                                        } elseif (isset($err['pass'])) {
                                            echo $err['pass'];
                                        } ?>
                                 </p>
                             ...
                             <!-- Nhập lại mật khẩu -->
                             <div class="mb-3">
                                 <label for="exampleInputPassword1" class="form-label">Nhập lại mật khẩu<span class="text-danger">*</span></label>
                             ...
                             <button type="submit" name="btn-update" class="hover:tw-bg-red-800 tw-border-red-800 tw-border tw-bg-white tw-text-red-800 tw-rounded tw-p-2 hover:tw-text-white">Đặt lại mật khẩu</button>
                         </form>
                     </div>
                 </div>
             </div>
