...
<div class="main-content my-5 container">
    ...
    <form action="index.php?url=account&act=edit" method="post" enctype="multipart/form-data">
        <!-- id -->
        ...
        <div class="mb-3">
            ...
            <input name="address" value="<?=isset($_SESSION['user']['address'])?$_SESSION['user']['name']:''?>"
        ...
        <input type="submit" name="btn-edit" value="Cập nhật" class="bg-danger border-0 rounded-2 p-2 text-light mt-3">
    </form>
</div>