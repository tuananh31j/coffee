                  ...
                  <div class="d-flex align-items-center gap-1">
                     ...
                     <div>
                        ...
                        <form class="d-flex " role="search">
                           <input class="form-control border-light text-light " style="font-size: 14px; width: 150px;"
                              type="search" placeholder="#Mã đơn hàng" aria-label="Search">
                     ...
                     <ul class="navbar-nav  mb-2 mb-lg-0">
                        ...
                        <li class="nav-item d-flex gap-4 align-items-center">
                           ...
                           <a class=" nav-link active p-2" aria-current="page" href="index.php?url=cart"><i
                                 class="fa-solid fa-cart-shopping"></i><span class="header-count-cart">2</span></a>
                        </li>
                        <?php }else{ ?>
